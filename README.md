...
- **apps/web** — Backoffice de gestión y página pública de cada restaurante (Next.js, puerto 3100).
...
pnpm dev                      # levanta api (4000), web (3100) y pay (3001)
```

- API: http://localhost:4000/health
- Backoffice: http://localhost:3100
